    ...
    <!-- <nav class="navbar navbar-expand søkeNav navbar-light m-0 p-0 ">
      <div class="collapse navbar-collapse" id="navbarNav">
        <div style="max-width:1400px;" class="container">
          <ul class="navbar-nav">
            <li class="nav-item active søkebarNav">
              <a class="nav-link" href="#">Alle</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Ifinavet</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Tekna</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Stillinger</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Sosialt</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Politisk</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Annet</a>
            </li>
            <li class="nav-item søkebarNav">
              <a class="nav-link" href="#">Utløpt</a>
            </li>
      ...
      <div class="row">
        <div class="col-3 pr-0">
          ...
          <div class="jobbtype">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item border-0 filter p-0 ml-1">
                <input id="frist1" class="gjørTilClickable" v-on:click="changeFrist(['frist', '7', $event.currentTarget.checked])" type="radio" name="frist">
                <label for="frist1" class="pl-2 mb-1 gjørTilClickable">Under en uke <span class="filterAntall">({{ alleTeknologierInfo.antallStillingerPerFrist["7"] }})</span></label>
              </li>
              <li class="list-group-item border-0 filter p-0 ml-1">
                <input id="frist3" class="gjørTilClickable" v-on:click="changeFrist(['frist', '30', $event.currentTarget.checked])" type="radio" name="frist">
                <label for="frist3" class="pl-2 mb-1 gjørTilClickable">Under 1 måned <span class="filterAntall">({{ alleTeknologierInfo.antallStillingerPerFrist["30"] }})</span></label>
              </li>
              <li class="list-group-item border-0 filter p-0 ml-1">
                <input id="frist7" class="gjørTilClickable" v-on:click="changeFrist(['frist', '90', $event.currentTarget.checked])" type="radio" name="frist">
                <label for="frist7" class="pl-2 mb-1 gjørTilClickable">Under 3 måneder <span class="filterAntall">({{ alleTeknologierInfo.antallStillingerPerFrist["90"] }})</span></label>
              </li>
              <li class="list-group-item border-0 filter p-0 ml-1">
                <input id="fristIngen" class="gjørTilClickable" v-on:click="changeFrist(['frist', '9000', $event.currentTarget.checked])" type="radio" name="frist" checked>
                <label for="fristIngen" class="pl-2 mb-1 gjørTilClickable">Under 12 måneder <span class="filterAntall">({{ alleTeknologierInfo.antallStillingerPerFrist["9000"] }})</span></label>
              </li>
            </ul>
          </div>
          <!-- <div class="firma">
          ...
          <div class="ferdigheter">
            ...
            <ul class="list-group list-group-flush">
              <li v-for="teknologi in alleTeknologierInfo.unikeTeknologier" v-bind:key="teknologi"
                ...
                <input @click="changeTekno(['skill', teknologi, $event.target.checked])" v-bind:name="teknologi" type="checkbox" v-bind:id="teknologi">
              ...
              <div class="card-body py-0 pr-2">
                <div class="row">
                  <div class="col-8">
                    ...
                    <p class="mt-2 mb-2">Du søkte etter: <span class="font-italic font-weight-bold">{{ settings.search.length > 0 ? settings.search : "Ingen. Fuckings. Ting." }}</span> </p>
                  </div>
                  ...
                  <div style="min-height:360px; max-height:360px;" class="card-body">
                    ...
                    <div style="position:absolute; bottom: 8px;"
                      ...
                      <div class="søkeButton card-1 d-flex justify-content-center align-items-center ml-3">
                        <a style="height:35px; width:100px; line-height:21px; color: #333; margin-top:12px; " v-bind:href="job.url" class="text-center">SØK</a>
                      </div>
                      <div class="more">
                        <a class="more" href="#">
...
<script>
  ...
  function axiosMe() {
    axios.get(`http://localhost:3000/api/jobs?type=${settings.value.type.join("+")}&sort=${settings.value.sort}&tekno=${settings.value.tekno.join("+")}&frist=${settings.value.frist}&search=${settings.value.search}`)
    ...
    setup() {
      ...
      function finnAntall() {
        ...
        hovedData.jobs.forEach(e => {
            ...
            if(differanse < 7) alleTeknologierInfo.antallStillingerPerFrist["7"] = alleTeknologierInfo.antallStillingerPerFrist["7"] + 1;
            if(differanse < 30) alleTeknologierInfo.antallStillingerPerFrist["30"] = alleTeknologierInfo.antallStillingerPerFrist["30"] + 1;
            if(differanse < 90) alleTeknologierInfo.antallStillingerPerFrist["90"] = alleTeknologierInfo.antallStillingerPerFrist["90"] + 1;
            if(differanse < 9000) alleTeknologierInfo.antallStillingerPerFrist["9000"] = alleTeknologierInfo.antallStillingerPerFrist["9000"] + 1;
          });
        return temp;
      }
