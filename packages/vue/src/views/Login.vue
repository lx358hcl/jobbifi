  ...
  <section class="login-clean loginRegister fyllSkjermen d-flex align-items-center">
    <div class="container">
      <div class="row no-gutters row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-2 justify-content-center" style="padding-right: 40px;padding-left: 40px;">
        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="border-bottom-left-radius: 30px; border-top-left-radius: 30px;  +
        padding-right: 0px;padding-left: 0px; background: url(assets/img/123.gif) no-repeat center center; 
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding-right: 0px;padding-left: 0px;">
          <form v-on:submit.prevent="login()" class="loginRegisterFormene d-flex flex-column justify-content-center align-content-center" id="loginBoks" method="post">
            ...
            <div class="illustration">
              <p style="font-family: 'Goudy Bookletter 1911', serif;color: rgb(45,45,45);font-weight: 900;margin-bottom: 0px;" class = "animate__animated animate__slower animate__swing">&amp;</p>
              <hr>
            ...
            <div class="form-group">
              <div id="visPassord" class="d-flex justify-content-center align-items-center" tabindex="0" style="cursor:pointer; background: rgb(247,249,252); border-bottom: 1px solid rgb(223,231,241);height: 100%;">
