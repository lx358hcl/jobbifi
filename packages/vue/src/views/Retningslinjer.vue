  ...
  <main class="homepage container">
    ...
    <body class="stackedit">
      ...
      <div class="stackedit__html">
        <h2><strong>Retningslinjer og personvern</strong></h2>
        <hr>
        <p><em>Disse retningslinjene gjelder fra og med 24. novemeber 2020.</em></p>
        <p>Ditt personsvern er viktig for NEVET. Det er derfor i NEVET’s ønske å respektere og beskytte all informasjon
          samlet inn og lagret på NEVET til den største grad mulig. All personlig informasjon som har blitt lagret på
          NEVET kan etterspørres å bli slettes hvis ønskelig. Bruken av NEVET forutsetter at brukeren har akseptert
          innsamlingen og lagringen av personlig informasjon på dette nettstedet.</p>
