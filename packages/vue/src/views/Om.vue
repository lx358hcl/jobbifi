<template>
  <main class="pt-5 homepage container">
    <div class="stackedit__html">
      ...
      <p>
        Vurderinger blir gjort om hvorvidt webcruiter, jobbsafari.no, karrierestart, jobbnorge.no og andre mindre studentbaserte jobbsider bør legges til.
      </p>
      <hr>
      <p>
        <strong>FAQ:</strong>
      ...
      <p>
        Hvis du ikke finner spørsmålet ditt nedenfor, send oss gjerne en mail:
      </p>
      <p>
      ...
      <hr>
      <p class="m-0 mb-2 pb-1">
        Luka Momcilovic and Igor Momcilovic
      </p>
    </div>
    <br>
  </main>
