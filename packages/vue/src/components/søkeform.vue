<template>
  <div class="row">
    <div class="s013 m-0 p-0">
      <div>
        <div class="d-flex justify-content-center" style="margin-left:10px; width:600px; position:absolute; top:50%; left:50%; transform:translate(-50%, -150%); margin-top:00px !important;">
          <div class="container">
            <div class="row d-flex justify-content-center">
              <h1 style="text-align: center; font-family: 'Spectral', serif !important;"><b>Jobbifi</b> | For late studenter som trenger jobb</h1>
            </div>
            <div class="d-flex justify-content-center row">
              <p class="mt-4 pt-4 mb-0" style="text-align: center; font-family: 'Spectral', serif !important;" id="skrivUt"></p>
            </div>
          </div>
        </div>
        <br>
            ...
            <div style="margin-right: -0px;" class="left rounded">
              <div class="input-wrap first">
                <div class="input-field first">
                  ...
                  <input type="text" placeholder="E.g. sommerjobb, vue, design, python, machine learning, haskell" aria-label="Search" v-on:input="searchQuery = $event.target.value" class="col-10" />
                </div>
              </div>
            </div>
            <button class="btn-search d-flex justify-content-center align-items-center" type="submit" style="width:50px;">
...
<script>
  ...
  export default {
    setup() {
      onMounted(() => {
        var skrivUt = document.querySelector("#skrivUt");
        var typewriter = new Typewriter(skrivUt, {
          autoStart: true,
          delay: 40,
          loop: true,
        });
        typewriter
          ...
          .pauseFor(1000)
          .deleteAll(40)
          .typeString('Søk og se om du finner noe interessant')
          .pauseFor(1000)
          .deleteAll(40)
          .start()
      });
